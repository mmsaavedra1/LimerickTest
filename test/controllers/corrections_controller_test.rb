...
class CorrectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create correction" do
    assert_difference('Correction.count') do
      post corrections_url, params: { correction: { corrected_user_id: @correction.corrected_user_id, file: @correction.file, score: @correction.score, type: @correction.type } }
    end
  ...
  test "should update correction" do
    patch correction_url(@correction), params: { correction: { corrected_user_id: @correction.corrected_user_id, file: @correction.file, score: @correction.score, type: @correction.type } }
