...
class ClasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clase" do
    assert_difference('Clase.count') do
      post clases_url, params: { clase: { Course_id: @clase.Course_id, professor: @clase.professor } }
    end
  ...
  test "should update clase" do
    patch clase_url(@clase), params: { clase: { Course_id: @clase.Course_id, professor: @clase.professor } }
